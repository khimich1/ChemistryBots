#!/usr/bin/env python3
"""
Тестовый скрипт для проверки доступа Смирнова Романа к групповому тарифу
"""
...
def test_roman_access():
    """Тестирует доступ Смирнова Романа к групповому тарифу"""
    
    roman_id = 727117860  # ID Смирнова Романа
    
    print("🧪 Тестирование доступа Смирнова Романа к групповому тарифу")
    print("=" * 60)
    ...
    try:
        ...
        is_approved = is_student_approved_by_teacher(roman_id)
        print(f"✅ Одобрен преподавателем: {'Да' if is_approved else 'Нет'}")
        
        # Проверяем доступ к групповому тарифу
        can_access = can_access_group_tariff(roman_id)
