...
• Экономия 390₽ в месяц по сравнению с самоподготовкой
...
def tariffs_kb(user_id: int = None) -> InlineKeyboardMarkup:
	...
	rows.extend([
	    [InlineKeyboardButton(text="📘 Самоподготовка — 390 ₽/мес", callback_data="buy_self")],
