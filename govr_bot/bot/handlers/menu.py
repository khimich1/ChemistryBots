...
async def how_bot_works(m: types.Message):
    text = (
        "🎓 <b>Как пользоваться ботом за 1 минуту</b>\n\n"
        "👉 <b>Что сделать прямо сейчас:</b>\n"
        "1️⃣ Открой ‘📚 Теория по химии’ и выбери тему\n"
        "2️⃣ Пройди ‘📝 Тесты’ — начни с ЕГЭ/ОГЭ\n"
        "3️⃣ Если задание не получается — ‘🔬 Решатор задач’: пришли текст или фото\n"
        "4️⃣ Раз в неделю — ‘📈 Получить отчёт’: получишь PDF со статистикой\n\n"
        "🎁 <b>Что ты получишь:</b>\n"
        "• Короткие понятные лекции с примерами и аудио\n"
        "• 30 заданий в тесте, мгновенная проверка и разбор ошибок\n"
        "• Подробные решения задач шаг за шагом\n"
        "• Личная статистика и рекомендации по темам\n"
        "• 🃏 Карточки для быстрого запоминания формул и терминов\n\n"
        "🧭 <b>Как заниматься эффективно:</b>\n"
        "• Схема: теория → тесты → работа над ошибками\n"
        "• 15–20 минут в день лучше, чем 2 часа раз в неделю\n"
        "• Задавай вопросы ИИ, если что-то непонятно\n\n"
        "📌 <b>Главные кнопки:</b>\n"
        "• 📚 Теория по химии — лекции по разделам\n"
        "• 📝 Тесты — тренировка ЕГЭ/ОГЭ и задания от преподавателя\n"
        "• 🔬 Решатор задач — решения по фото/тексту\n"
        "• 📈 Получить отчёт — PDF со прогрессом\n"
        "• 🃏 Карточки — быстрое повторение\n\n"
        "Удачи! Начни с любой темы — дальше я подскажу."
    )
